...
func main() {
	...
	for !windowShouldClose {
		...
		switch currentScreen {
		case Logo:
			rl.DrawText("THIS IS A TEST", 20, 20, 40, rl.LightGray)
		...
		case Title:
			...
			rl.DrawText("THIS IS A TEST", 20, 20, 40, rl.DarkGreen)
		...
		case GamePlay:
			...
			rl.DrawText("THIS IS A TEST", 20, 20, 40, rl.Maroon)
		...
		case Ending:
			...
			rl.DrawText("THIS IS A TEST", 20, 20, 40, rl.DarkBlue)
